...
כל אתר מצולם פעמיים — `<slug>.jpg` לעברית ו־`<slug>-en.jpg` לאנגלית — באותו
viewport, אותה חיתוך ואותן השהיות, כך ששני הצילומים ממסגרים בדיוק את אותו דבר
ורק שפת העמוד שונה. הסקריפט מנסה קודם `/en`, ואם זו לא המוסכמה באתר הוא מאתר את
כפתור המעבר לפי השם הנגיש שלו ולוחץ עליו כמו שמבקר היה עושה. הוא שומר צילום
אנגלי רק אחרי שה־`lang` של המסמך מאשר שהעמוד באמת באנגלית — כפתור שלא עשה כלום
לא ייחשב כמעבר מוצלח, והצילום העברי נשאר במקומו.

**קבצי ה־`-en` הנוכחיים הם עותקים של העברי.** לא הייתה גישת רשת לשלושת האתרים
מהסביבה שבה נכתב הקוד, אז הם נזרעו כך כדי שהעמוד באנגלית לא יציג תמונה שבורה.
ההרצה הבאה של `project-shots.yml` תחליף אותם בצילומים אנגליים אמיתיים.
